        ...
        <div className="space-y-12 text-sm text-muted">
          ...
          <section>
            ...
            <ul className="space-y-3 list-disc list-inside">
              <li><strong className="text-white/90">Monitor (Free):</strong> $0/month. Non-production environments only. Unlimited AIS, light AI change visibility, 1 Lite AURA/month. Usage: 10 ACE events/month, 1 AI agent. Evaluation: 1 AURA/month (lite depth, not exportable). Add-on: Full AURA $99 one-time/month (not exportable). Email support.</li>
